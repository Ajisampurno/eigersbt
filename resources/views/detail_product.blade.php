								...
								<div class="col-lg-7 col-sm-12 mt-20">
										<div class="container">
											...
											<div class="brk-sc-info-grid d-flex flex-wrap pt-2 pb-3">
												<div class="">
													<a target="_blank" href="https://api.whatsapp.com/send?phone={{hp($data->whatsapp)}}&text=*Halo%2C%20{{config('app.name')}}%20%F0%9F%91%8B*%0ASaya%20ingin%20order%20produk%20ini%20:%20%0A%0A{{$data_product->productname}}%20%0A{{url('/')}}/product/detail/{{$data_product->url_segment}}" class="btn btn-prime btn-lg border-radius-30 font__family-open-sans font__weight-bold m-0 pr-30 pl-30 brk-sc-shop-item__info-btn letter-spacing-40" style="cursor: pointer;">
